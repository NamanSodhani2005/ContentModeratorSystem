"""
Run the full training pipeline in one go:
1) Train hate speech head (if dataset available)
2) Preprocess embeddings + hate scores
3) Train DQN agent
"""
...
def train_all():
    ...
    # Step 1: Train hate speech head (optional)
    ...
    # Step 2: Preprocess embeddings (and hate scores if head exists)
    print("Step 2: Preprocessing embeddings...")
    preprocess_main()
